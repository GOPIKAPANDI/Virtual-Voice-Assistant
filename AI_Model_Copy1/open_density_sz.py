...
def open_browser():
    ...
    url = "https://10.174.67.31:8443/cas/login?service=%2Fwsg%2Flogin%2Fcas"
    driver.get(url)
    ...
    try:
        ...
        # https://10.174.67.31:8443/wsg/#m/accessPoint
        driver.get("https://10.174.67.31:8443/wsg/#m/accessPoint")
